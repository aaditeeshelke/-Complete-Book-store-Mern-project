...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:5000/api/auth/publishers/count')
      .then(res => setPublisherCount(res.data.count))
      .catch(err => console.error(err));

    axios.get('http://localhost:5000/api/auth/books/count')
      .then(res => setBookCount(res.data.count))
      .catch(err => console.error(err));

      axios.get('http://localhost:5000/api/auth/purchases/by-date')
      .then(res => {
    ...
    axios.get('http://localhost:5000/api/auth/users/count-by-role')
      .then(res => {
      ...
      const fetchPurchaseData = async () => {
        try {
          const response = await axios.get('http://localhost:5000/api/auth/purchases/by-publisher');
